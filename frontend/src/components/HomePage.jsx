      ...
      >
        ...
        >
          <Typography
            ...
            component="h1"
            gutterBottom
            sx={{ fontFamily: 'Lucida Console, Monaco, monospace', fontWeight: 'bold', fontStyle: 'italic' }}
          >
            Codemon
          </Typography>

          <Typography variant="body1">
            An online IDE that provides AI assistance while you unleash your creativity.
          </Typography>
        </Box>
        <Slider {...settings} style={{ width: '100%' }}>
          <div>
            ...
            <Typography variant="body1">
            Regardless of your experience level in coding, <br />Codemon offers a platform where you can write code and explore your creative potential.
            </Typography>
          </div>
          <div>
            <Typography variant="h4" component="h1" gutterBottom>
